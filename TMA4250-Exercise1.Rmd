...
```{r, echo = F, eval = T, out.width = "50%", fig.align = "center"}
x = rep(seq(1, 30, length.out = 30), each = 30)
y = rep(seq(1, 30, length.out = 30),30)
